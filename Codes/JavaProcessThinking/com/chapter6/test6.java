...
public class test6 {
	...
	public String toString() {
		return id+": "+id+", temp: "+temp+", tempInt: "+tempInt
				+", v1: "+this.v1+", v2: "+this.v2+", array: "+this.ArraytoString(this.array)+
				", arrayFinal: "+this.ArraytoString(this.arrayFinal)+", vv: "+vv.i+
				", vv1: "+vv1.i;
	}
	public static void main(String[] args) {
		test6 t6=new test6("lpw");
		System.out.println(t6);
		
		for(int i=0;i<t6.array.length;i++) {
			t6.array[i]++;
			t6.arrayFinal[i]++;
		}
