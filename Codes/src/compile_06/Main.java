...
public class Main {
	public static void main(String[] args) {
		...
		fileProcess.fileProcess("C:\\Users\\lpw\\Desktop\\3.txt");
		...
		/*System.out.println("\n-------编号---------");
		ArrayList<String> litEn=Tools.enCode(grammer);
		for(int i=0;i<litEn.size();i++) {
			System.out.println(litEn.get(i));
		}*/
